...
It appears that the line players number of pushups are less than the number of pushups from the skill players. 
...
The null hypothesis is $H_0$ is, "There is no difference between the average pushups of players in the line or skill positions."

The boxplot indicates a significant difference between the pushups distributions of players in the two positions. The numerical summary show line players number of pushups are, on average 17.12500, and the skill player number of pushups are, on average 49.72727.

A t-test of difference in means gave a p-value of 0.000009421, this is less than 0.05, so we rejct the null hypothesis and conclude we have evidence of a difference in average numbers of pushups between players in the two positions.